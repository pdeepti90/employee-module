package com.altimetrik.bugtracker.employeemodule.config;
...
public class SwaggerConfig {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.altimetrik.bugtracker.projectmodule.rest.resource")).paths(regex("/.*"))
